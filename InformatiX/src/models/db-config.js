...
const {createTablesUsers,  createTablesResetPasswordToken, createTablesProbleme, createTablesRating, createTablesClase, 
  createTablesClasaElev, createTablesTeme, createTablesProblemeTeme }= require('./createTabels');
